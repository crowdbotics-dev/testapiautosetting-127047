...
## Project Structure
    ...
    ├── testapiautosetting_127047  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127047`
...
2. Clone this repo and `cd testapiautosetting_127047`
